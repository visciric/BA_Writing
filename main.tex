...
\thesistitle{Inferring mutations from single cell transcriptomics of kidney’s filtering system}             % Thesis title,              command: \ttitle
\thesistype{Bachelor Thesis}             % Type of thesis (e.g. Master Thesis) \ttype
\thesisdate{July 16, 2026}                     % Date of submission                  \tdate
\keywords{Choose Keywordss}
                                        % Keywords for the thesis,            \keywordnames
\author{Riccardo Viscio}                  % Your name,                          \authorname
...
\studyprogramlink{https://www.zhaw.ch/de/lsfm/studium/bachelor/applied-digital-life-sciences}
                                        % Link to study program               \studyproglink

\supervisorA{Dr. Tugçe Bilgin Sonay}       % Name of supervisor 1,               \supnameA
\supervisorAmail{bilg@zhaw.ch}         % Email address of supervisor 1,      \supmailA
\supervisorAweb{https://www.zhaw.ch/de/ueber-uns/person/bilg/}  %            \supwebA
...
\supervisorB{Prof. Dr. Maria Anisimova}              % Name of supervisor 2,               \supnameB
\supervisorBmail{maria.anisimova@zhaw.ch}       % Email address of supervisor 2,      \supmailB
\supervisorBweb{https://www.zhaw.ch/de/ueber-uns/person/anis}                  % \supwebB
...
\include{Chapters/AITools}
\include{Chapters/CodeAvailability} 
